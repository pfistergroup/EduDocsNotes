...
\begin{itemize}
\item<1-> From $\left[ \vecnot{v} \right]_{\mathcal{B}}^H G \left[ \vecnot{u} \right]_{\mathcal{B}} = \inner{ \vecnot{u} }{ \vecnot{v} }
= \overline{ \inner{ \vecnot{v} }{ \vecnot{u} } } = \left( \left[ \vecnot{u} \right]_{\mathcal{B}}^H G \left[ \vecnot{v} \right]_{\mathcal{B}} \right)^H$, we see that
...
Then, $\tinner{ \vecnot{w}-\vecnot{u} }{ \vecnot{u} } = 0$ and \vspace{-1mm}
...
Using $\tinner{ \vecnot{w}-\vecnot{u} }{ \vecnot{u} } = 0$, we can write \vspace{-1mm}
\begin{align*}
...
\begin{proof}<2->
The inner product $\inner{ \vecnot{v} }{ \vecnot{w}_i }$ is given by \vspace{-1mm}
\begin{equation*}
\begin{split}
...
%\begin{equation*}
%W^{\bot} = \left\{ \vecnot{v} \in V \tinner{ \vecnot{v} }{ \vecnot{w} } = 0 \; \forall \; \vecnot{w}\in W \right\}. 
%\end{equation*}
%\end{definition}
%
%\end{frame}
